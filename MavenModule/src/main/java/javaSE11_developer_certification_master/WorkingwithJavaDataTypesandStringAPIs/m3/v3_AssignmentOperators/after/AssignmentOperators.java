package javaSE11_developer_certification_master.WorkingwithJavaDataTypesandStringAPIs.m3.v3_AssignmentOperators.after;
...
public class AssignmentOperators {
    public static void main(String[] args) {
        ...
        int xInt = 5;     int yInt = 3;
        yInt *= xInt; // 15  yInt = yInt * xInt

        out.println("yInt = " + yInt);
